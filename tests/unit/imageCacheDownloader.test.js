...
describe('imageCacheDownloader tests', () => {
  ...
  function build() {
    ...
    return proxyquire('../../ZelBack/src/services/appLifecycle/imageCacheDownloader', {
      ...
      '../appRequirements/hwRequirements': { systemArchitecture: systemArchitectureStub },
  ...
  describe('inspectImage', () => {
    it('returns compressed size + digest for a private image and resolves creds keyed per owner', async () => {
      const dl = build();
