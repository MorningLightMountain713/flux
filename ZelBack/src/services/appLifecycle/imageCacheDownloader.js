...
// short-lived tokens against it), so one owner's creds never reuse another's. The
// image-cache payload is decrypted with the v8 enterprise envelope, so each image's
// repoauth arrives as plaintext — getCredentials detects the form and passes
