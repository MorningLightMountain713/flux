    ...
    env = await createTestEnv({
      ...
      configOverrides: {
        fluxapps: {
          ...
          // Lives under fluxapps - limitCounterStore.limitsFor reads
          // config.fluxapps.limitCounters; placed at the config root it never
          // takes effect and the production numbers apply.
          limitCounters: {
